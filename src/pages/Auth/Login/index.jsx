        ...
        <div className='bg-white flex flex-col gap-4 p-4 md:p-6 shadow-lg rounded-2xl'>
          <form>
            ...
            <button
              ...
              className='bg-green-800 text-white font-semibold rounded-lg py-2 w-full hover:bg-slate-900 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2'
            >
              Login
            </button>
          </form>
